...
<main class="main">
        ...
        <div class="wrapper">
            <div class="cart">
                ...
                <div class="cart__empty">
                    ...
                    <p class="text-preset-4">Your added items will appear here</p>
                </div>
                <div class="cart__wrapper hidden">
                    ...
                    <div class="cart__confirm">
                        <button class="text-preset-3 cart__confirm__button">Confirm Order</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div id="my-modal" class="modal">
        <div class="modal-content">
            ...
            <div class="modal__total"></div>
            <div class="modal-footer">
          <button class="text-preset-3 cart__confirm__button close">Start New Order</button>
        </div>
    </div>
  </div>
</main>
